...
const PlayerPiece = ({filter, score, playerTurn, fill}) => {
  ...
  return ( 
    <svg
        ...
        style={{fillOpacity: 1, stroke: 'none', backgroundSize:'100%', fill, left: `${currentLocation.left}%`, top: `${currentLocation.top}%`, position:'absolute', transition: 'all 0.5s linear'}}
      >
        <defs>
          <filter id="f4" x="0" y="0" width="200%" height="200%">
            <feOffset result="offOut" in="SourceGraphic" dx="40" dy="-5" />
